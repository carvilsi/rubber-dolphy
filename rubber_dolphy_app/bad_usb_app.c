...
BadUsbApp* bad_usb_app_alloc(char* arg) {
    ...
    // Exfiltrate  Widget
    app->exfltwdg = widget_alloc();
    view_dispatcher_add_view(
        app->view_dispatcher, BadUsbAppViewExfiltrate, widget_get_view(app->exfltwdg));
...
void bad_usb_app_free(BadUsbApp* app) {
    ...
    // Exfiltrate Widget
    view_dispatcher_remove_view(app->view_dispatcher, BadUsbAppViewExfiltrate);
    widget_free(app->exfltwdg);
